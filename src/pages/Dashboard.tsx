  ...
  return (
    <Layout>
      ...
      <section className="dashboard-hero-container fade-in-up">
        ...
        <div className="dashboard-hero-content">
          <div className="fade-in-up delay-1">
            <p className="eyebrow">DigiNeuro Marker</p>
      ...
      <section className="grid-3">
        <Link
          className="card card-link dashboard-card fade-in-up delay-3"
          to="/assessments"
        >
          <h2>検査メニュー</h2>
          <p>眼・腕・歩行・姿勢・表情・音声・問診を確認できます。</p>
        ...
        <Link className="card card-link dashboard-card fade-in-up delay-4" to="/records">
          ...
          <span className="text-link">記録を見る</span>
        </Link>
        <Link className="card card-link dashboard-card fade-in-up delay-5" to="/review">
          <h2>医師レビュー</h2>
          <p>動画と数値を同期表示し、短時間で確認できます。</p>
          <span className="text-link">レビュー画面</span>
        </Link>
      </section>

      <AssessmentGuideSpotlight />
