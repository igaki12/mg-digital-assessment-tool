const publicFiles = {
  ...
  "ptosis.remaining10": "ptosis-remaining-10.wav",
  "ptosis.done": "ptosis-done.wav",
  "limbs.start": "limbs-start.wav",
  "limbs.duration90": "limbs-duration-90.wav",
  "limbs.positioning": "limbs-positioning.wav",
  "limbs.progress30": "limbs-progress-30.wav",
  "limbs.progress60": "limbs-progress-60.wav",
  "limbs.remaining10": "limbs-remaining-10.wav",
  "limbs.done": "limbs-done.wav",
  "gait.start": "gait-start.wav",
  "gait.recordingStart": "gait-recording-start.wav",
  "tug.prep": "tug-prep.wav",
  "tug.positioning": "tug-positioning.wav",
  "tug.ready": "tug-ready.wav",
  "tug.measuring": "tug-measuring.wav",
  "tug.done": "tug-done.wav",
  ...
  "expression.restHold": "expression-rest-hold.wav",
  "expression.smile": "expression-smile.wav",
  "expression.smileHold": "expression-smile-hold.wav",
  "expression.nextSet": "expression-next-set.wav",
...
const pageIntroFiles = {
  ...
  "pageIntro.tug": "page-intro-tug.wav",
